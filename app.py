...
with tab_dashboard:
    ...
    main_col, rail_col = st.columns([2.6, 1], gap="large")
    ...
    with main_col:
        ...
        var_row1 = st.columns(2)
        var_row2 = st.columns(2)
        limit_cols = [var_row1[0], var_row1[1], var_row2[0]]
        var_usage = {}
        for col, pair in zip(limit_cols, PAIRS):
            with col, st.container(border=True):
        ...
        with var_row2[1], st.container(border=True):
